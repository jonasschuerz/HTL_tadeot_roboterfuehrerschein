========================================================================
       KONSOLENANWENDUNG : EducationLineKonsole01
========================================================================


Diese EducationLineKonsole01-Anwendung hat der Anwendungs-Assistent für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, die Ihre EducationLineKonsole01-Anwendung bilden.

EducationLineKonsole01.dsp
...
StdAfx.h, StdAfx.cpp
    ...
    EducationLineKonsole01.pch und einer vorkompilierten Typdatei namens StdAfx.obj verwendet.
