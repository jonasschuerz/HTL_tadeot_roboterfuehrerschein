========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : FtLibDemo1
========================================================================


Diese FtLibDemo1-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre FtLibDemo1-Anwendung bilden.
...
FtLibDemo1.h
	...
	Anwendungsklasse CFtLibDemo1App.
...
res\FtLibDemo1.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei FtLibDemo1.rc eingebunden.
...
FtLibDemo1Dlg.h, FtLibDemo1Dlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CFtLibDemo1Dlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in FtLibDemo1.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	FtLibDemo1.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
